...
# Interpretação 1 da questão : 
#	Todos os clientes : Apenas os nomes.
#	Cor de suas casas : Apenas as cores das casas.
#	Seus bairros : Apenas os nomes dos bairros. 
#	Seus carros : Apenas os modelos
...
# Interpretação 2 da questão : 
#	Todos os clientes : Apenas os nomes e sobrenomes.
#	Cor de suas casas : Apenas as cores das casas.
#	Seus bairros : Apenas os nomes dos bairros. 
#	Seus carros : Apenas os modelos
...
# Interpretação 3 da questão : 
#	Todos os clientes : Apenas os ids, nomes e sobrenomes.
#	Cor de suas casas : Apenas as cores das casas.
#	Seus bairros : Apenas os nomes dos bairros. 
#	Seus carros : Apenas os modelos
...
# Interpretação 4 da questão : 
#	Todos os clientes : todas as informações dos clientes.
#	Cor de suas casas : Apenas as cores das casas.
#	Seus bairros : Apenas os nomes dos bairros. 
#	Seus carros : Apenas os modelos
